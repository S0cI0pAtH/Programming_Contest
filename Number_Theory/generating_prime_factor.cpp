...
codechef : April challenge2017
Problem Name : Chef and Divisor Tree
Problem Code : CHEFDIV

check: generating prime factors in a range < 10 ^ 5, numbers can ber up to 10 ^ 12
...
void gen_div(){  // generating prime factors in a range < 10 ^ 5, numbers can ber up to 10 ^ 12
    for( auto pr : primes ){
        ll first = a / pr;
        if( a % pr ) first++;
        first *= pr;
